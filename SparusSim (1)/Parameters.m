...
Para.S0.ma_q = 62.7322;    % pitch
Para.S0.ma_r = 52.4246;    % yaw
...
% Main Body S0;
Para.S0.kuu = 17.5247;    % surge
Para.S0.kvv = 112.3446;    % sway
Para.S0.kww = 111.9702;    % heave
Para.S0.kpp = 1.2748;    % roll
Para.S0.kqq = 38.0782;    % pitch
Para.S0.krr = 36.2608;    % yaw
