...
Para.S0.m= 52; 
Para.S0.I_xx = 0.3669;    
Para.S0.I_yy = 11.6769;    
Para.S0.I_zz = 11.66401;    
...
% Main Body S0;
Para.S0.ma_u = 2.8938;    % surge
Para.S0.ma_v = 68.8134;    % sway
Para.S0.ma_w = 68.0463 ;    % heave
Para.S0.ma_p = 0.1275;    % roll
Para.S0.ma_q = 57.6557;    % pitch
Para.S0.ma_r = 57.5011;    % yaw
...
% Main Body S0;
Para.S0.kuu = 9.965160845825379;    % surge
Para.S0.kvv = 57.89464585257;    % sway
Para.S0.kww = 61.089857906950144;    % heave
Para.S0.kpp = 0.207557422377454;    % roll
Para.S0.kqq = 12.998644756401214;    % pitch
Para.S0.krr = 9.580349881305480;    % yaw
